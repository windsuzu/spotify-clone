...
const Sidebar = () => {
    ...
    return (
        <div className="text-gray-500 p-5 border-r border-gray-900 h-screen overflow-y-scroll scrollbar-hide text-xs lg:text-sm sm:max-w-[12rem] lg:max-w-[14rem] hidden md:inline-flex">
